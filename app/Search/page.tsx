...
function loadAnimeInfo(url: string, setAnimeInfo: React.Dispatch<React.SetStateAction<AnimeInfo>>) {
        ...
        {searchResponse.map((anime) => {
          return (
            <div key={anime.url} className='border'>
              <div className="anime" onClick={() => { loadAnimeInfo(anime.url, setAnimeInfo) }}>
